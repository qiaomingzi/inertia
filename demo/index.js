...
define("qdm/js/homepage/index.88d1c.js", [ "lib.Zepto","qdm/js/common/components/Aside.6dba4.js","qdm/js/common/components/Inertia.dedc0.js"], function(require, exports, module) {
    var $ = require("lib.Zepto");
    var Aside = require("qdm/js/common/components/Aside.6dba4.js");
    var Inertia = require("qdm/js/common/components/Inertia.dedc0.js");
    //var Inertia = require("qdm/_popupAD.9e939.js");
        ...
        initAside: function() {
            new Aside($("#asideTrigger"), {
                onInit: function() {
                    ...
                    //ejs.render("#tpl-recently-read.html", data)
                    $("#recentlyRead").html("---");
                }
            });
        },
